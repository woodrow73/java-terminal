...
public class ColorUtil {
    ...
    static Color[] rainbow = { Color.red, Color.orange, Color.yellow, Color.green, Color.blue, new Color(75, 0, 130),
            new Color(148, 0, 211) };

    static Color[] almostRainbow = { Color.red, B_Red, Color.yellow, Color.green, Color.cyan,
     ...
     */
    public static double colourDistance(int[] c1, int[] c2, boolean useAlpha) {
        if(!useAlpha) {
    ...
    public static double colourDistance(Color c1, Color c2) {
        return colourDistance(new int[]{ c1.getRed(), c1.getGreen(), c1.getBlue()},
    ...
    public static Color getContrastingColor(Color c) {
        ...
        do {
            rand = getRandomColor();
        } while(colourDistance(c, rand) < 222);
